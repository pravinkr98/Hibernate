...
public class ManyToManyDAOImpl implements IManyToManyDAO {
	...
	public void saveDataUsingParent() {
		...
		//set child to parent
		zee.setSubscribers(Set.of(ramesh, ganesh, venkatesh));
		star.setSubscribers(Set.of(ganesh, venkatesh));
		//set parent to child
		ramesh.setChannels(Set.of(zee));
		ganesh.setChannels(Set.of(zee,star));
		venkatesh.setChannels(Set.of(zee,star));
		try {
			//create or locate Tx
	...
	public void saveDataUsingChild() {
		...
		//set child to parent
		sony.setSubscribers(Set.of(hari, john, raja));
		utv.setSubscribers(Set.of(hari, raja));
		//set parent to child
		john.setChannels(Set.of(sony));
		hari.setChannels(Set.of(sony,utv));
		raja.setChannels(Set.of(sony,utv));
		try {
			//create or locate Tx
			if(!ses.getTransaction().isActive())
				tx=ses.beginTransaction();
